...
class LogRegModel(BaseRecommender):
    """
    Custom recommender based on a scikit-learn Logistic Regression model.
    ...
    def fit(self, log: DataFrame, user_features: Optional[DataFrame] = None, item_features: Optional[DataFrame] = None):
        ...
        # print("Starting scikit-learn Logistic Regression model training (numeric features only)...")
