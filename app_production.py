...
app = Flask(__name__)
app.secret_key = os.environ.get('SECRET_KEY', 'ucla-cs145-recsys-competition-2024')
app.config['MAX_CONTENT_LENGTH'] = 16 * 1024 * 1024  # 16MB max file size

# Production paths - adjust for UCLA CS server environment
...
def safe_evaluate_submission(submission_path, team_name):
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            eval_file = os.path.join(BASE_DIR, 'evaluation.py')
            if os.path.exists(eval_file):
                shutil.copy2(eval_file, temp_dir)
            ...
            for dir_name in required_dirs:
                ...
                if os.path.exists(dir_path) and os.path.isdir(dir_path):
                    shutil.copytree(dir_path, os.path.join(temp_dir, dir_name))
